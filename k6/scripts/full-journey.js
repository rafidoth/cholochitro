...
import { get, post, authGet, authPost, authDelete, parseJson, isSuccess } from '../lib/api.js';
import { getTestUserCredentials } from '../lib/auth.js';
 ...
 * 
 * Run: k6 run k6/scripts/full-journey.js
 * With profile: k6 run k6/scripts/full-journey.js -e PROFILE=load
 */
